  ...
  <div class="col-md-4">
    <form method="GET" action="">
      ...
      <select name="filter" class="form-select" onchange="this.form.submit()">
        ...
        <option value="taken" <?= $filter === 'taken' ? 'selected' : '' ?>>Taken Tasks</option>
        <option value="done" <?= $filter === 'done' ? 'selected' : '' ?>>Done Tasks</option>
        <option value="yours" <?= $filter === 'yours' ? 'selected' : '' ?>>Your Tasks</option>
        <option value="yourdone" <?= $filter === 'yourdone' ? 'selected' : '' ?>>Your Done Tasks</option>
      </select>
    </form>
  </div>
</div>
...
if (mysqli_num_rows($res1) === 0): ?>
  <div class="d-flex justify-content-center align-items-center text-center" style="height: 300px; width: 100%;">
    <div>
      ...
      <p class="text-muted">Try changing the filter or <a href="?page=project&&id=<?php echo $id_project; ?>">reload this page</a>.</p>
    </div>
  </div>
<?php else: ?>
  ...
  ?>
    <div class="p-2 col-4">
      <div class="card card-outline card-primary text-truncate"
