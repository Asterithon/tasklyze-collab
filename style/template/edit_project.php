<div class="modal fade" id="projectEdit<?php echo $id_project; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <form id="projectForm" class="modal-content" action="config/aksi_edit_project.php" method="post" novalidate>
            ...
            <div class="modal-body">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="projectName" name="projectName"
                        placeholder="Enter project name" required aria-required="true" aria-describedby="nameHelp"
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control" id="projectDescription" name="projectDescription" rows="4"
                        placeholder="Enter project description" required aria-required="true"
