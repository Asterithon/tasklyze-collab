            ...
            <div class="card card-row card-secondary " style="min-width: 25%;">
                ...
                <div class="card-body">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header" data-bs-toggle="modal"
                            data-bs-target="#newTask" style='cursor: pointer;'>
                    ...
                    <div class="card card-info card-outline">
                        <div class="card-header" style='cursor: pointer;' data-toggle="modal" data-target="#modal-contributor">
